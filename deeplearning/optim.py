...
def sgd_momentum(w, dw, config=None):
    ...
    # the next_w variable. Also use and update the velocity v.                  #
    #############################################################################
...
def rmsprop(x, dx, config=None):
    ...
    # in the next_x variable. Then update cache value stored in                 #
    # config['cache'].                                                          #
    #############################################################################
...
def adam(x, dx, config=None):
    ...
    # the next_x variable. Then update the m, v, and t variables stored         #
    # in config.                                                                #
    #############################################################################
    t += 1
